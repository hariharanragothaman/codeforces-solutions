...
# question
"""
Question can be assumed to be finding all paths from given start node to end node
"""
...
if __name__ == '__main__':
    ...
    for node, parent in enumerate(connections, 2):
        graph[node] = parent

    #print("The graph is:", graph)
    paths = find_path(1, router_count, graph)
    print(*paths)
